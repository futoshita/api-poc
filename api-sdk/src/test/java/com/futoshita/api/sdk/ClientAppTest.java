...
public class ClientAppTest {
    ...
    private final String GET_RESOURCE_URI = "http://localhost:8080/api-server/api/greeting/hello";
    private final String GET_SECURED_RESOURCE_URI = "http://localhost:8080/api-server/api/greeting/hello/secured";

    private final String POST_USER_URI = "http://localhost:8080/api-server/api/users";
