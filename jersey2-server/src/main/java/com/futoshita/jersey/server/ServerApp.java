...
import com.futoshita.jersey.server.entity.provider.MoxyJsonContextResolver;
...
public class ServerApp extends ResourceConfig {
    ...
    public ServerApp() {
        ...
        packages("com.futoshita.jersey.server.oauth");

        if (LOGGER.isDebugEnabled()) {
            LOGGER.debug("registering webservice resources...");
        }

        packages("com.futoshita.jersey.server.resource");
